      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/leads/:id" element={<ProtectedRoute><ViewLead /></ProtectedRoute>} />
            ...
            <Route path="/client-portal/:clientId" element={<ProtectedRoute><ClientPortal /></ProtectedRoute>} />
